...
$class_cfg = array(
	...
	'www.cakeberry.ru'	=> DIR_ROOT.'/class'
);
...
/******* Mysql ******/
//fwrite($f, 'подключаем /class.db.php \n');
include_once '/home/vinci-1/cakeberry.ru/docs/class/class.db.php';
//include_once DIR_CLASS.'/class.db.php';
//fwrite($f, 'подключили /class.db.php \n');
...
//fwrite($f, 'config   Mysql \n');

/*DB::db_set($db_cfg);
DB::db_connect();
DB::db_set_names();*/

$mysql_mylink = mysql_connect($db_cfg['cakeberry.ru'][0], $db_cfg['cakeberry.ru'][2], $db_cfg['cakeberry.ru'][3]);
mysql_select_db($db_cfg['cakeberry.ru'][1]);
...
$_VARS = array(
	...
	'multi_lang'		=> false,		// многоязычный сайт
